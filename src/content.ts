...
export const caseStudies: CaseStudy[] = [
  {
    slug: "dkumoves",
    title: "DKU Moves",
    type: "Product strategy · UX/UI · Mobile engineering",
    period: "2026 — present",
    ...
    tags: ["Product ownership","Interaction design","Design system","React Native"],
    cover: "",
    ...
    stack: "Expo 54 · React Native · TypeScript · Expo Router",
    ...
    buildIntro: "I treated the MVP as a conversation artifact and an engineering foundation at the same time: complete enough to review real flows, modular enough to replace mock behavior without rewriting the interface.",
    buildPoints: [
      "Built reusable cards, segmented controls, progress bars, empty states, and action patterns from shared design tokens.",
      "Implemented dashboard, activity logging, challenges, badges, rankings, rewards, sharing, profile, and authentication flows.",
      "Separated screens from a store/service layer so backend APIs and object storage can replace local mock behavior cleanly.",
      "Designed validation, loading, success, error, sold-out, locked, pending, and empty states—not only ideal screenshots.",
    ],
    architecture: ["Expo Router screens","Feature modules","Reusable UI primitives","App store","Replaceable service layer","Future API + object storage"],
    collaboration: [
    ...
    outcome: "The result is a functional cross-platform MVP that expresses the redesigned product model end to end. It is ready for stakeholder review and backend integration, with the riskiest interactions and state transitions already made tangible.",
    evidence: [
