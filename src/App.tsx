    ...
    items: [
      {
        ...
        images: [resolveAsset("/piano.webp")]
      },
      {
        id: 2,
        ...
        images: [resolveAsset("/guitar.webp")]
      },
      {
        id: 3,
        ...
        images: [resolveAsset("/choir1.webp"), resolveAsset("/choir2.webp")]
      }
    ]
  },
  sports: {
    ...
    items: [
      {
        ...
        images: [resolveAsset("/tennis1.webp"), resolveAsset("/tennis2.webp")]
      }
    ]
  },
  education: {
    ...
    items: [
      {
        ...
        images: [
          resolveAsset("/education1.webp"), 
          resolveAsset("/education2.webp"), 
...
const COLLAGE_ITEMS: CollageItem[] = [
  ...
  { id: 'img1', type: 'image', src: resolveAsset('/piano.webp'), alt: 'Piano', caption: { en: '@ Piano', zh: '@ 钢琴' } },
  ...
  { id: 'img2', type: 'image', src: resolveAsset('/guitar.webp'), alt: 'Guitar', caption: { en: '@ Guitar', zh: '@ 吉他' } },
  
  // Row 2: Image, Image, Text
  { id: 'img3', type: 'image', src: resolveAsset('/choir1.webp'), alt: 'Choir', caption: { en: '@ Choir', zh: '@ 合唱团' } },
  { id: 'img4', type: 'image', src: resolveAsset('/choir2.webp'), alt: 'Choir', caption: { en: '@ Choir', zh: '@ 合唱团' } },
  ...
  { id: 'img5', type: 'image', src: resolveAsset('/tennis1.webp'), alt: 'Tennis', caption: { en: '@ Tennis', zh: '@ 网球' } },
  { id: 'img6', type: 'image', src: resolveAsset('/tennis2.webp'), alt: 'Tennis', caption: { en: '@ Tennis', zh: '@ 网球' } },

  // Row 4: Image, Text, Image
  { id: 'img7', type: 'image', src: resolveAsset('/education1.webp'), alt: 'Education', caption: { en: '@ Volunteer', zh: '@ 志愿服务' } },
  ...
  { id: 'img8', type: 'image', src: resolveAsset('/education2.webp'), alt: 'Education', caption: { en: '@ Social Work', zh: '@ 社会工作' } },

  // Row 5: Image, Image, Text
  { id: 'img9', type: 'image', src: resolveAsset('/crisis1.webp'), alt: 'Crisis Center', caption: { en: '@ Crisis Center', zh: '@ 危机中心' } },
  { id: 'img10', type: 'image', src: resolveAsset('/crisis2.webp'), alt: 'Support', caption: { en: '@ Support', zh: '@ 支持' } },
